(function(angular, SockJS, Stomp, _, undefined) {
	angular.module("testManager.services").service("updateService", function($q, $timeout, $http, $log, $rootScope) {
	...
	angular.module("testManager.services").service("notificationService", function($q, $http, $log, $rootScope, updateService) {
